...
const els = {
  ...
  lesionState: $("lesionState"), size: $("sizeRange"), along: $("btnAlong"), across: $("btnAcross"),
...
els.size.oninput = () => { if (!S.sb) els.lesionState.textContent = `切口 ${els.size.value}%`; };
