...
export function readStoredProvider(storage: Pick<Storage, "getItem"> = window.localStorage): StoredProviderConfig {
  try {
...
export function initialProviderState(storage: Pick<Storage, "getItem"> = window.localStorage): ProviderInitialState {
