...
export function candidatePoints(candidate) {
...
export function directionProvenance(direction = {}) {
  return {
...
export function editFingerprint(editRecord) {
  const raw = [
...
export function editRecordIsActive(editRecord = {}) {
...
export function normalizeEditHistoryEntry(base, raw, index, baseVersion) {
  const entry = {
...
export function versionedEditProvenance(base, editRecord, sessionHistory = null) {
