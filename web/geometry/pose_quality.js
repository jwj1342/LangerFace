// Runtime face pose / expression quality gates for research overlays.
// Pure functions only: no DOM, no canvas, no model state.
...
export function frameMotionNorm(lm, previousLandmarks, anchors = POSE_MOTION_ANCHORS) {
