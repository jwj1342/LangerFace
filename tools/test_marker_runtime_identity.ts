...
for (const key of ["algorithmName", "profile", "implementationVersion", "branch", "head", "worktreeId", "sourceDigest", "assetDigest"] as const) {
...
console.log("身份检查通过：正确候选身份放行；名称、profile、源码和默认旧版本等错误均拒绝。");
