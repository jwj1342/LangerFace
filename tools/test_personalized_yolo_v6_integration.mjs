...
assert.equal(atlas.lines.length, 159, "the capture flow must use the latest v8.1.69 atlas");
assert.equal(atlas.lines.reduce((count, line) => count + line.points.length, 0), 15_272,
