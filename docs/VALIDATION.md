...
| 照片 / 视频 / 实时叠加 | #19 工程验收门禁 | `tools/audit_incision_overlay_acceptance.mjs` 汇总脱敏 photo/video/camera evidence，检查照片投射、视频复放/导出、摄像头稳定、浏览器 runtime error 和资源 404 证据是否同时满足 |
